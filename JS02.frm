...
Text16 = Format(CCur(Text15) * CCur(Text14), "##,###")
...
If RCari2.RowCount <> 0 Then
    ...
    Text8 = Format(RCari2("SumOfTotal"), "##,###")
End If
RCari2.Close
Set RCari2 = Nothing
...
If RCari2.RowCount <> 0 Then
    'On Error GoTo ErrorHandler
    Text9 = Format(RCari2("SumOfBiaya"), "##,###")
End If
RCari2.Close
Set RCari2 = Nothing
   ...
   Do Until RCari.EOF
      ...
      grid1.Row = B
         With grid1
            ...
            .Col = 3: .Text = Format(RCari("Harga"), "##,###")
            .Col = 4: .Text = RCari("Jumlah")
            .Col = 5: .Text = Format(RCari("Total"), "##,###")
         End With
      B = B + 1
      RCari.MoveNext
   Loop
   ...
   Do Until RCari2.EOF
      ...
      grid2.Row = B
         With grid2
            ...
            .Col = 3: .Text = Format(RCari2("Biaya"), "##,###")
         End With
      B = B + 1
      RCari2.MoveNext
   Loop
...
Text14 = Format((grid3.TextMatrix(grid3.Row, 2)), "##,###")
Text15.SetFocus
End Sub
...
Text27 = Format((grid4.TextMatrix(grid4.Row, 2)), "##,###")
End Sub
...
End If
    ...
    Text12 = Format(CCur(Text10) - CCur(Text11), "##,###")
...
Text10 = Format(CCur(Text8) + CCur(Text9), "##,###")
End Sub
