...
If RCari3.RowCount <> 0 Then
    ...
    Text1 = RCari3("KodeBR")
    Text2 = RCari3("namaBR")
    Text5 = Format(RCari3("HBeli"), "##,###")
    Text4 = Format(RCari3("HJual"), "##,###")
    Text6 = RCari3("Persen")
...
cboText = Combo4.Text
lencboText = Len(Combo4.Text)
If Not cekKey Then
For tmp = 0 To Combo4.ListCount - 1
If UCase(Left(Combo4.Text, Combo4.SelStart)) = UCase _
(Combo4.List(tmp)) Then
ChangeFlag = True
Combo4.Text = Combo4.List(tmp)
...
For tmp = 0 To Combo4.ListCount - 1
If UCase(Left(Combo4.List(tmp), _
lencboText)) = UCase(cboText) Then
tmpLen = lencboText
ChangeFlag = True
Combo4.Text = Combo4.List(tmp)
Combo4.SelStart = tmpLen
Combo4.SelLength = Len(Combo4.List( _
tmp)) - tmpLen
ChangeFlag = False
Exit For
End If
