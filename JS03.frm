   ...
   Do Until RCari.EOF
      ...
      grid2.Row = B
         With grid2
            ...
            .Col = 9: .Text = Format(RCari("Sparepart"), "##,###")
            .Col = 10: .Text = Format(RCari("Servis"), "##,###")
            Text10 = Format(RCari("TOTAL"), "##,###")
            Text11 = Format(RCari("BAYAR"), "##,###")
            Text12 = Format(RCari("SISA"), "##,###")
   ...
   Do Until RCari3.EOF
      ...
      grid3.Row = B
         With grid3
            ...
            .Col = 3: .Text = Format(RCari3("Harga"), "##,###")
         End With
      B = B + 1
      RCari3.MoveNext
   Loop
   ...
   Do Until RCari4.EOF
      ...
      grid4.Row = B
         With grid4
            ...
            .Col = 2: .Text = Format(RCari4("Biaya"), "##,###")
         End With
      B = B + 1
      RCari4.MoveNext
   Loop
