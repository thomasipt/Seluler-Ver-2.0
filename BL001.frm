...
If RCari.RowCount <> 0 Then
    Text9 = Format(RCari("MutasiD"), "##,###")
    Text5 = Format(RCari("MutasiC"), "##,###")
    Text4 = Format(RCari("Saldo"), "##,###")
End If
RCari.Close
Set RCari = Nothing
   ...
   Do Until RCari4.EOF
      ...
      grid.Row = B
         With grid
              ...
              .Col = 4: .Text = Format(RCari4("Harga_PCS"), "##,###")
              .Col = 5: .Text = Format(RCari4("Jml_Harga"), "##,###")
         End With
      B = B + 1
      RCari4.MoveNext
   Loop
