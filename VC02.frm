...
crpt.ReportFileName = App.Path + "\ReportSELULER\DafVC.rpt"
...
Else
    ...
    Text5 = Format(CCur(Text3) - (CCur(Text4) * CCur(Text6) / 100), "##,###")
End If
End Sub
